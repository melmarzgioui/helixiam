...
export const company: Record<Locale, CompanyStr> = {
  en: {
    metaTitle: "About",
    metaDesc:
      "HelixIAM is the European identity fabric for humans, AI agents and workloads — engineered in Europe.",
    eyebrow: "About HelixIAM",
    title: 'Identity infrastructure for the <span class="grad-text">next decade</span>.',
    lead: "We're building the identity fabric that authenticates everyone and everything — people, AI agents, and machine workloads — on open standards, with European sovereignty at its core.",
    leadP1:
    ...
    leadP3:
      "We're engineered in Europe — because we believe the systems that decide who gets in should answer to you, not to a control plane on another continent.",
    values: [
  ...
  fr: {
    metaTitle: "À propos",
    metaDesc:
      "HelixIAM est la plateforme d'identité européenne pour les humains, les agents IA et les charges de travail — conçue en Europe.",
    eyebrow: "À propos de HelixIAM",
    title: 'Une infrastructure d\'identité pour la <span class="grad-text">prochaine décennie</span>.',
    lead: "Nous construisons la plateforme d'identité qui authentifie tout le monde et tout — les personnes, les agents IA et les charges de travail — sur des standards ouverts, avec la souveraineté européenne en son cœur.",
    leadP1:
    ...
    leadP3:
      "Nous sommes conçus en Europe — parce que nous croyons que les systèmes qui décident qui entre devraient vous répondre à vous, et non à un plan de contrôle situé sur un autre continent.",
    values: [
  ...
  nl: {
    metaTitle: "Over ons",
    metaDesc:
      "HelixIAM is de Europese identiteitslaag voor mensen, AI-agents en workloads — ontwikkeld in Europa.",
    eyebrow: "Over HelixIAM",
    title: 'Identiteitsinfrastructuur voor het <span class="grad-text">komende decennium</span>.',
    lead: "We bouwen de identiteitslaag die iedereen en alles authenticeert — mensen, AI-agents en machine-workloads — op open standaarden, met Europese soevereiniteit als kern.",
    leadP1:
    ...
    leadP3:
      "We zijn ontwikkeld in Europa — omdat we geloven dat de systemen die bepalen wie er binnenkomt aan jou verantwoording moeten afleggen, niet aan een control plane op een ander continent.",
    values: [
