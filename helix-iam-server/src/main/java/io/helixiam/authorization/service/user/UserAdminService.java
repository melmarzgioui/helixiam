...
import io.helixiam.authorization.domain.user.admin.UserAdminDto;
import io.helixiam.authorization.domain.user.admin.UserChangePasswordDto;
import io.helixiam.authorization.domain.user.admin.UserPasswordDto;
import io.helixiam.authorization.domain.user.admin.UserWriteDto;
...
public class UserAdminService {
    ...
    @Autowired(required = false)
    private io.helixiam.authorization.service.agent.AgentOwnerReviewService agentOwnerReviewService;
