...
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprCredentialMeta;
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprFederatedLink;
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprLoginEvent;
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprOrgMembership;
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprProfile;
import io.helixiam.authorization.domain.gdpr.GdprExportDto.GdprRealmMembership;
    ...
    public GdprEraseResultDto erase(final GdprEraseDto erase) {
        ...
        consents.list(erase.realmId(), erase.userId()).stream()
                ...
                .forEach(clientId -> consents.withdraw(
                        new io.helixiam.authorization.domain.gdpr.GdprConsentWithdrawDto(erase.realmId(), erase.userId(), clientId)));
