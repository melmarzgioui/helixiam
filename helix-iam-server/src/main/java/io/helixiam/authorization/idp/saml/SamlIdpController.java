...
public class SamlIdpController {
    ...
    public SamlIdpController(final SamlIdpProperties properties, final SamlAuthnRequestParser parser,
                            ...
                            final io.helixiam.authorization.service.UserInfoService userInfoService) {
     ...
     * resolved via the shared {@link io.helixiam.authorization.service.UserInfoService} — so claims are
    ...
    private String applicationIdForSp(final String spEntityId) {
        try {
            ...
            return rpSource.load(realm).stream()
                    ...
                    .map(io.helixiam.authorization.amqp.saml.SamlRelyingPartyConfig::applicationId)
