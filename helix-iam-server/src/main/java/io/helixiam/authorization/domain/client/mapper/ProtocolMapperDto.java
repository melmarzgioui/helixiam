...
/**
 * Helix IAM (Wave 3): a per-client protocol mapper (subscriber copy). Maps a {@code source} (a user-profile
 * attribute key, or a hardcoded value) into {@code claimName} in the access and/or ID token. {@code mapperType}
 * is {@code USER_ATTRIBUTE} or {@code HARDCODED}.
 */
