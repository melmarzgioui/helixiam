package io.helixiam.authorization.amqp.webhook.adapter;
...
import io.helixiam.authorization.service.webhook.WebhookAdminService;
...
public class WebhookConfigLocalAdapter implements WebhookConfigPublisher {
    ...
    public WebhookSubscriptionDto save(final WebhookSubscriptionDto dto) {
        return bridge.to(service.save(
                bridge.to(dto, io.helixiam.authorization.domain.webhook.WebhookSubscriptionDto.class)),
