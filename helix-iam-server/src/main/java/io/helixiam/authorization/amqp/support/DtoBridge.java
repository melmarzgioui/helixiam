...
package io.helixiam.authorization.amqp.support;
 ...
 * {@code io.helixiam.authorization.amqp.client.ClientDto} (front) and
 * {@code io.helixiam.authorization.domain.client.admin.ClientDto} (store) are byte-identical record shapes
