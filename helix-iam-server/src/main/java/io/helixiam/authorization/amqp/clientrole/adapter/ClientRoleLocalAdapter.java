package io.helixiam.authorization.amqp.clientrole.adapter;
...
import io.helixiam.authorization.service.client.ClientRoleAdminService;
...
public class ClientRoleLocalAdapter implements ClientRolePublisher {
    ...
    public ClientRoleDto createRole(final ClientRoleWriteDto write) {
        return bridge.to(service.createClientRole(
                bridge.to(write, io.helixiam.authorization.domain.client.role.ClientRoleWriteDto.class)),
                ClientRoleDto.class);
    }
    ...
    public ServiceAccountRoleDto assignServiceAccountRole(final ServiceAccountRoleDto write) {
        return bridge.to(service.assignServiceAccountRole(
                bridge.to(write, io.helixiam.authorization.domain.client.role.ServiceAccountRoleDto.class)),
