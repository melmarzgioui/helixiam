...
/**
 * Vendored from io.helixiam.subscriber.starter.security.utils (starter-security module).
 * Not in the Task 1 file list; pulled in transitively as Task 2 folded
 * io.helixiam.authorization.service.key.KeyMaterialService, which needs
