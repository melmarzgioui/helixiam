...
public class FederatedLinkService {
    ...
    public java.util.List<group.mfnr.authorization.domain.federation.FederatedLinkView> linksForUser(final String userId) {
        return repository.findAllByUserId(userId).stream()
                .map(group.mfnr.authorization.domain.federation.FederatedLinkView::from).toList();
    }
