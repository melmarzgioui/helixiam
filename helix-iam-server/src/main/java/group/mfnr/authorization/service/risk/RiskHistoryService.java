package group.mfnr.authorization.service.risk;

import group.mfnr.authorization.domain.risk.KnownDevice;
import group.mfnr.authorization.domain.risk.KnownLoginIp;
import group.mfnr.authorization.domain.risk.RiskLoginRecord;
import group.mfnr.authorization.domain.risk.RiskSignalRequest;
import group.mfnr.authorization.domain.risk.RiskSignals;
import group.mfnr.authorization.repository.risk.KnownDeviceRepository;
import group.mfnr.authorization.repository.risk.KnownLoginIpRepository;
...
public class RiskHistoryService {
    ...
    public RiskSignals evaluate(final RiskSignalRequest request) {
        ...
        signals.setRecentFailureCount(loginFailureRepository.findByRealmIdAndUserId(realmId, userId)
                .map(group.mfnr.authorization.domain.security.LoginFailure::getFailureCount)
                .orElse(0));
        return signals;
    }
