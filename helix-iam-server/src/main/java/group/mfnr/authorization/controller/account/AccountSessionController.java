...
import group.mfnr.authorization.session.AccountSessionService;
import group.mfnr.authorization.session.AccountSessionService.AccountConsent;
import group.mfnr.authorization.session.SsoSessionView;
