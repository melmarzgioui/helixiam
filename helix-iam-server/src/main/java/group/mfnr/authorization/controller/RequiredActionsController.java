...
import group.mfnr.authorization.security.requiredactions.RequiredActionsGate;
...
public class RequiredActionsController {
    ...
    public RequiredActionsController(final UserAdminPublisher userPublisher,
                                     final group.mfnr.authorization.flow.FlowExecutor flowExecutor,
                                     final group.mfnr.authorization.amqp.AuthFlowPublisher authFlowPublisher,
                                     final group.mfnr.authorization.flow.persistence.AuthFlowMapper authFlowMapper,
