 ...
 * Scoped to {@code group.mfnr.authorization.controller} so it never touches the OAuth/OIDC/SAML hot paths.
 */
@RestControllerAdvice(basePackages = "group.mfnr.authorization.controller")
