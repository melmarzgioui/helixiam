...
import group.mfnr.authorization.service.MfaService;
...
public class FlowController {
    ...
    private String flowPath(final String path) {
        return group.mfnr.authorization.security.realm.RealmPaths.prefixed(
                group.mfnr.authorization.security.realm.RealmContextHolder.get(), path);
    }
}
