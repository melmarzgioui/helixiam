package group.mfnr.authorization.security.session;
 ...
 * completion) — the same points that resume the saved request ({@link group.mfnr.authorization.security.flow.ResolveSavedRequestRedirect}).
 */
