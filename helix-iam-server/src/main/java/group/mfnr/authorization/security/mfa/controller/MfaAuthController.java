package group.mfnr.authorization.security.mfa.controller;
...
import group.mfnr.authorization.security.mfa.totp.QrCode;
...
public class MfaAuthController {
    ...
    private void applySessionPolicy(final HttpServletRequest request) {
        sessionPolicyApplier.applyOnLogin(request, group.mfnr.authorization.security.realm.RealmContextHolder.get());
    }
