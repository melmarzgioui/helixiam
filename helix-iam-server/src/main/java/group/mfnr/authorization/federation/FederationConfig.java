...
import group.mfnr.authorization.federation.ldap.JndiLdapDirectory;
import group.mfnr.authorization.federation.ldap.LdapDirectory;
import group.mfnr.authorization.federation.oidc.HttpOidcTokenClient;
...
import group.mfnr.authorization.federation.saml.SamlAssertionReplayCache;
...
public class FederationConfig {
    ...
    @Bean
    public group.mfnr.authorization.federation.ldap.LdapAuthenticationService ldapAuthenticationService(final LdapDirectory directory) {
        return new group.mfnr.authorization.federation.ldap.LdapAuthenticationService(directory);
    }
