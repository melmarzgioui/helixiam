...
public class OidcIdentityProvider implements IdentityProvider {
    ...
    private final group.mfnr.authorization.federation.UpstreamLogoutClient upstreamLogoutClient;
    ...
    public OidcIdentityProvider(final OidcProviderConfig config, final OidcTokenClient tokenClient,
        ...
        this(config, tokenClient, nonceGenerator, new group.mfnr.authorization.federation.UpstreamLogoutClient.Http());
    }

    public OidcIdentityProvider(final OidcProviderConfig config, final OidcTokenClient tokenClient,
                                final Supplier<String> nonceGenerator,
                                final group.mfnr.authorization.federation.UpstreamLogoutClient upstreamLogoutClient) {
        this.config = config;
