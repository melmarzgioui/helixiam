...
import group.mfnr.authorization.federation.eid.EidArtifactResolver;
...
import group.mfnr.authorization.federation.eid.EidSamlIdentityProvider;
import group.mfnr.authorization.federation.oidc.OidcIdentityProvider;
...
import group.mfnr.authorization.federation.oidc.SocialProviders;
import group.mfnr.authorization.federation.saml.Saml2IdentityProvider;
...
public class FederationProviderFactory {
     ...
     */
    public IdentityProvider fromStored(final group.mfnr.authorization.amqp.federation.IdentityProviderConfig stored) {
    ...
    private static OidcProviderConfig oidcFromStored(
            final group.mfnr.authorization.amqp.federation.IdentityProviderConfig stored, final Map<String, String> c) {
    ...
    private static EidProviderConfig eidFromStored(
            final group.mfnr.authorization.amqp.federation.IdentityProviderConfig stored, final String protocol,
            final Map<String, String> c) {
        final group.mfnr.authorization.federation.eid.EidScheme scheme = eidScheme(protocol, c.get("scheme"));
    ...
    private static group.mfnr.authorization.federation.eid.EidScheme eidScheme(final String protocol, final String override) {
        final String value = override == null || override.isBlank() ? protocol : override;
        return switch (value.toLowerCase()) {
            case "eidas" -> group.mfnr.authorization.federation.eid.EidScheme.EIDAS;
            case "eherkenning" -> group.mfnr.authorization.federation.eid.EidScheme.EHERKENNING;
            case "digid", "eid" -> group.mfnr.authorization.federation.eid.EidScheme.DIGID;
