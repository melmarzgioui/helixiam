package group.mfnr.authorization.domain.client.admin;
...
/**
 * Helix IAM E8.5-S3: subscriber-side view of an OAuth client (two-copy DTO; mirrors the publisher's
 * {@code amqp.client.ClientDto}). {@code secret} is only populated on create / regenerate.
 */
