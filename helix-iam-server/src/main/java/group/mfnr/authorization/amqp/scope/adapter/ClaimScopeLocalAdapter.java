package group.mfnr.authorization.amqp.scope.adapter;
...
public class ClaimScopeLocalAdapter implements ClaimScopePublisher {
    ...
    private group.mfnr.authorization.domain.scope.admin.ScopeRef ref(final ScopeRef ref) {
        return bridge.to(ref, group.mfnr.authorization.domain.scope.admin.ScopeRef.class);
    }
    ...
    public ClaimDto createClaim(final ClaimWriteDto write) {
        return bridge.to(service.createClaim(
                bridge.to(write, group.mfnr.authorization.domain.scope.admin.ClaimWriteDto.class)), ClaimDto.class);
    }
    ...
    public ClientScopeDto createScope(final ScopeWriteDto write) {
        return bridge.to(service.createScope(
                bridge.to(write, group.mfnr.authorization.domain.scope.admin.ScopeWriteDto.class)),
    ...
    public SubjectClaimDto setSubjectClaim(final SubjectClaimDto write) {
        return bridge.to(service.setSubjectClaim(
                bridge.to(write, group.mfnr.authorization.domain.scope.admin.SubjectClaimDto.class)),
