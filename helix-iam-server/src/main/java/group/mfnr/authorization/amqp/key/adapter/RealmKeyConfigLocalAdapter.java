package group.mfnr.authorization.amqp.key.adapter;

import com.fasterxml.jackson.core.type.TypeReference;
import group.mfnr.authorization.amqp.key.RealmKeyConfigPublisher;
import group.mfnr.authorization.amqp.key.RealmKeyView;
import group.mfnr.authorization.amqp.support.DtoBridge;
import group.mfnr.authorization.service.key.RealmKeyService;
...
public class RealmKeyConfigLocalAdapter implements RealmKeyConfigPublisher {
    ...
    public RealmKeyView rotate(final String realmId) {
        return bridge.to(
                group.mfnr.authorization.domain.realm.RealmKeyView.from(service.rotate(realmId)),
                RealmKeyView.class);
    }
