package group.mfnr.authorization.amqp.group.adapter;
...
import group.mfnr.authorization.amqp.group.GroupMemberDto;
...
import group.mfnr.authorization.service.group.GroupAdminService;
...
public class GroupAdminLocalAdapter implements GroupAdminPublisher {
    ...
    private group.mfnr.authorization.domain.group.admin.GroupRef ref(final GroupRef ref) {
        return bridge.to(ref, group.mfnr.authorization.domain.group.admin.GroupRef.class);
    }
    ...
    public GroupDto create(final GroupWriteDto write) {
        return bridge.to(service.create(
                bridge.to(write, group.mfnr.authorization.domain.group.admin.GroupWriteDto.class)), GroupDto.class);
    }
