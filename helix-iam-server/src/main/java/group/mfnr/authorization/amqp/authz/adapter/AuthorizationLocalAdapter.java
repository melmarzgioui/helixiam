package group.mfnr.authorization.amqp.authz.adapter;

import com.fasterxml.jackson.core.type.TypeReference;
import group.mfnr.authorization.amqp.authz.AuthorizationPublisher;
import group.mfnr.authorization.amqp.authz.AuthzEvalRequest;
import group.mfnr.authorization.amqp.authz.AuthzEvalResult;
...
import group.mfnr.authorization.service.authz.AuthorizationAdminService;
...
public class AuthorizationLocalAdapter implements AuthorizationPublisher {
    ...
    public AuthzServerDto setServer(final AuthzServerDto write) {
        return bridge.to(service.setServer(
                bridge.to(write, group.mfnr.authorization.domain.authz.AuthzServerDto.class)),
    ...
    public AuthzScopeDto createScope(final AuthzScopeDto write) {
        return bridge.to(service.createScope(
                bridge.to(write, group.mfnr.authorization.domain.authz.AuthzScopeDto.class)),
                AuthzScopeDto.class);
    }
    ...
    public AuthzResourceDto createResource(final AuthzResourceDto write) {
        return bridge.to(service.createResource(
                bridge.to(write, group.mfnr.authorization.domain.authz.AuthzResourceDto.class)),
    ...
    public AuthzPolicyDto createPolicy(final AuthzPolicyDto write) {
        return bridge.to(service.createPolicy(
                bridge.to(write, group.mfnr.authorization.domain.authz.AuthzPolicyDto.class)),
    ...
    public AuthzPermissionDto createPermission(final AuthzPermissionDto write) {
        return bridge.to(service.createPermission(
                bridge.to(write, group.mfnr.authorization.domain.authz.AuthzPermissionDto.class)),
    ...
    public AuthzEvalResult evaluate(final AuthzEvalRequest req) {
        return bridge.to(service.evaluate(
                bridge.to(req, group.mfnr.authorization.domain.authz.AuthzEvalRequest.class)),
