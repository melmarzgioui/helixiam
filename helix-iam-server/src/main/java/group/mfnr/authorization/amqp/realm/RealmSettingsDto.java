package group.mfnr.authorization.amqp.realm;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;

/**
 * Helix IAM E8.5-S4: publisher-side view of a realm's settings (two-copy DTO; mirrors the subscriber's
 * {@code domain.realm.admin.RealmSettingsDto}). Backs the console's Realm settings screen.
 */
