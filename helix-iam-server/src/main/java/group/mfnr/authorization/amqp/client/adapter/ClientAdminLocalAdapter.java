package group.mfnr.authorization.amqp.client.adapter;
...
import group.mfnr.authorization.amqp.client.ClientRef;
import group.mfnr.authorization.amqp.client.ClientWriteDto;
import group.mfnr.authorization.amqp.support.DtoBridge;
import group.mfnr.authorization.service.client.ClientAdminService;
...
public class ClientAdminLocalAdapter implements ClientAdminPublisher {
    ...
    public ClientDto create(final ClientWriteDto write) {
        return bridge.to(service.create(
                bridge.to(write, group.mfnr.authorization.domain.client.admin.ClientWriteDto.class)),
                ClientDto.class);
    }
    ...
    public ClientDto update(final ClientWriteDto write) {
        return bridge.to(service.update(
                bridge.to(write, group.mfnr.authorization.domain.client.admin.ClientWriteDto.class)).orElse(null),
                ClientDto.class);
    }
