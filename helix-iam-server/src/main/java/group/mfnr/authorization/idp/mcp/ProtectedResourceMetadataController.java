package group.mfnr.authorization.idp.mcp;
 ...
 * {@code /realms/{realm}/.well-known/oauth-protected-resource}. The {@link group.mfnr.authorization.security.realm.RealmRoutingFilter}
