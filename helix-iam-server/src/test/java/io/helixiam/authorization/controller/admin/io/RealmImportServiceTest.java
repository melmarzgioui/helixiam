...
class RealmImportServiceTest {
    ...
    private io.helixiam.authorization.amqp.application.ApplicationConfigPublisher apps;
    private io.helixiam.authorization.amqp.webhook.WebhookConfigPublisher webhooks;
    private io.helixiam.authorization.amqp.scim.ScimTargetConfigPublisher scims;
    private io.helixiam.authorization.amqp.workloadidentity.WorkloadIdentityConfigPublisher workloads;
    private io.helixiam.authorization.amqp.group.GroupAdminPublisher groupPub;
    private io.helixiam.authorization.amqp.user.UserAdminPublisher userPub;
    ...
    void setUp() {
        ...
        apps = mock(io.helixiam.authorization.amqp.application.ApplicationConfigPublisher.class);
        webhooks = mock(io.helixiam.authorization.amqp.webhook.WebhookConfigPublisher.class);
        scims = mock(io.helixiam.authorization.amqp.scim.ScimTargetConfigPublisher.class);
        workloads = mock(io.helixiam.authorization.amqp.workloadidentity.WorkloadIdentityConfigPublisher.class);
        groupPub = mock(io.helixiam.authorization.amqp.group.GroupAdminPublisher.class);
        userPub = mock(io.helixiam.authorization.amqp.user.UserAdminPublisher.class);
    ...
    void newSlices_applicationCreated_andWebhookSecretResolved() {
        ...
        final io.helixiam.authorization.amqp.application.ApplicationConfig app =
                new io.helixiam.authorization.amqp.application.ApplicationConfig("src", "billing-suite", "Billing",
                        "email", "browser", true, "Billing Suite");
        final io.helixiam.authorization.amqp.webhook.WebhookSubscriptionDto wh =
                new io.helixiam.authorization.amqp.webhook.WebhookSubscriptionDto(null, "src", "audit", "https://hook",
        ...
        final org.mockito.ArgumentCaptor<io.helixiam.authorization.amqp.application.ApplicationConfig> appCap =
                org.mockito.ArgumentCaptor.forClass(io.helixiam.authorization.amqp.application.ApplicationConfig.class);
        ...
        final org.mockito.ArgumentCaptor<io.helixiam.authorization.amqp.webhook.WebhookSubscriptionDto> whCap =
                org.mockito.ArgumentCaptor.forClass(io.helixiam.authorization.amqp.webhook.WebhookSubscriptionDto.class);
    ...
    void groupHierarchyRemapped_andUserRolesAssigned() {
        ...
        when(groupPub.create(any())).thenAnswer(inv -> {
            final io.helixiam.authorization.amqp.group.GroupWriteDto w = inv.getArgument(0);
            return new io.helixiam.authorization.amqp.group.GroupDto(w.realmId(), "gid-" + w.name(), w.name(),
                    w.parentId(), 0, List.of());
        });
        when(userPub.create(any())).thenAnswer(inv -> {
            final io.helixiam.authorization.amqp.user.UserWriteDto w = inv.getArgument(0);
            return new io.helixiam.authorization.amqp.user.UserAdminDto(w.realmId(), "uid-" + w.username(),
                    w.username(), w.email(), w.enabled(), w.locked(), false, List.of(), w.attributes(), 0L);
        });

        final io.helixiam.authorization.amqp.group.GroupDto parent =
                new io.helixiam.authorization.amqp.group.GroupDto("src", "src-staff", "staff", null, 0, List.of());
        final io.helixiam.authorization.amqp.group.GroupDto child =
                new io.helixiam.authorization.amqp.group.GroupDto("src", "src-fin", "finance", "src-staff", 0,
                        List.of("ledger-writer"));
        final io.helixiam.authorization.amqp.user.UserAdminDto user =
                new io.helixiam.authorization.amqp.user.UserAdminDto("src", "src-u1", "alice", "alice@x.io", true, false,
        ...
        final org.mockito.ArgumentCaptor<io.helixiam.authorization.amqp.group.GroupWriteDto> gw =
                org.mockito.ArgumentCaptor.forClass(io.helixiam.authorization.amqp.group.GroupWriteDto.class);
        verify(groupPub, org.mockito.Mockito.times(2)).create(gw.capture());
        final io.helixiam.authorization.amqp.group.GroupWriteDto childWrite = gw.getAllValues().stream()
        ...
        final org.mockito.ArgumentCaptor<io.helixiam.authorization.amqp.role.RoleAssignment> ra =
                org.mockito.ArgumentCaptor.forClass(io.helixiam.authorization.amqp.role.RoleAssignment.class);
