...
class ServiceProviderServiceTest {
    ...
    void getRegisteredClientByClientId_withinItsRealm_resolves() {
        ...
        final ServiceProviderService service = new ServiceProviderService(repo, org.mockito.Mockito.mock(group.mfnr.authorization.repository.application.ApplicationRepository.class), "/nonexistent");
