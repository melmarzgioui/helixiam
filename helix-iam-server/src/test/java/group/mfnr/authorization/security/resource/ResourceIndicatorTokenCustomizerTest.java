...
class ResourceIndicatorTokenCustomizerTest {
    ...
    void requestedAllowedResourceSetsAudience() {
        final ResourceIndicatorPublisher publisher = mock(ResourceIndicatorPublisher.class);
        when(publisher.allowedResourcesForClient(group.mfnr.authorization.support.RealmScopedKey.pack("master", "svc-client")))
    ...
    void noAllowListAcceptsAnyValidResource() {
        final ResourceIndicatorPublisher publisher = mock(ResourceIndicatorPublisher.class);
        when(publisher.allowedResourcesForClient(group.mfnr.authorization.support.RealmScopedKey.pack("master", "svc-client"))).thenReturn(List.of()); // no allow-list
    ...
    void multipleResourceValuesAllSetAsAudience() {
        final ResourceIndicatorPublisher publisher = mock(ResourceIndicatorPublisher.class);
        when(publisher.allowedResourcesForClient(group.mfnr.authorization.support.RealmScopedKey.pack("master", "svc-client"))).thenReturn(List.of());
